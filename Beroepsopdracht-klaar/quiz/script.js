...
function finishQuiz() {
  ...
  if (playerData.goodAnswers > 2) {
    beloning = "Dat deed je heel goed. Je verdient wel een beloning, helaas heb ik er alleen geen.";
  }
  else if (playerData.goodAnswers == 2 ){
    beloning = "Bijna perfect, goed gedaan.";
  }
  else {
    beloning = "Volgende keer beter."
  }
  resultBox.innerHTML = "<h2>Jouw resultaat: <br>goede antwoorden: " + playerData.goodAnswers + "<br>foute antwoorden: " + playerData.wrongAnswers + "<br>" + beloning + "</h2>";
